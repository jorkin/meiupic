CREATE TABLE meu_albums ( id integer NOT NULL primary key, name varchar(50) NOT NULL, cover_id int(11) NOT NULL DEFAULT 0, cover_ext varchar(20) DEFAULT NULL, comments_num int(11) NOT NULL DEFAULT 0, photos_num int(11) NOT NULL DEFAULT 0, create_time int(11) NOT NULL DEFAULT 0, up_time int(11) NOT NULL DEFAULT 0, tags varchar(255) DEFAULT NULL, priv_type tinyint(1) NOT NULL DEFAULT 0, priv_pass varchar(100) DEFAULT NULL, priv_question varchar(255) DEFAULT NULL, priv_answer varchar(255) DEFAULT NULL, desc longtext, deleted tinyint(1) NOT NULL DEFAULT 0 , enable_comment tinyint(1) default 1);
